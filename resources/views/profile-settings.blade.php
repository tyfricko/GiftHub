<x-layout>
  <div class="container mx-auto px-6 py-12">
    <x-ui.card>
      ...
      <p class="text-neutral-600 mb-4">The "Settings" page has been removed. Settings will be consolidated into user profile and account pages in a future release.</p>
